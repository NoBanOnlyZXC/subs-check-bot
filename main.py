...
Заказ от: https://t.me/yaneleylaa
Саурс: https://zelenka.guru/
Тема: https://zelenka.guru/threads/6683261/
Исполнитель: https://t.me/NoBanOnlyZXC

Заказ выполнен как бесплатный и имеет 2 дня поддержки.
Код может быть импользован в других проектах и получить статус open-source на репозиториях исполнителя в GitHub, GitLab и т.д.
'''
